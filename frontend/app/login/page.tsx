...
export default function TestPage() {
  ...
  const handleSubmit = async (e: FormEvent) => {
    try {
      ...
      const payload = JSON.stringify({ email: email, password, role_tab: loginAs });
      ...
      <div className="basis-1/2 h-max">
        <div className="flex flex-col h-screen">
          ...
          <div className="flex flex-col items-center my-32">
            ...
            {/* Mode Selector */}
            <div className="flex bg-gray-100 rounded-xl p-1 mt-2 w-2/3">
              <button
                type="button"
    ...
    `}
            ...
            <form onSubmit={handleSubmit} className="w-full my-6">
              ...
              <div className="mt-10 flex justify-center ">
                ...
                <p className="capitalize flex flex-row justify-end mr-36 my-4">doesn&apos;t have an account? <a href="/register" className="text-primary">Register</a> </p>
            </form>
          </div>
        
        </div>
      </div>
      <div className="basis-1/2  bg-[url('/bg-login.jpg')] bg-cover bg-center ">
